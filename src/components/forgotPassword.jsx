        ...
        <body className="app">
            <section className="login-content">
                <div className="login-content-lt">
                    <div className="logo"><img src={logo} alt="Rishabh Software" /></div>
                    <div className="logo-sm"><img src={logo_sm} alt="Rishabh Software" /></div>
                </div>
                        ...
                        <form className="login-form" action="#">
                            ...
                            <div className="form-group">
                                ...
                                <div className="input-addon">
                                    ...
                                    <div className="icon-before"><i className="icon-email"></i></div>
